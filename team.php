...
<body style="background-image: url(images/123.jpg); background-size: cover; background-repeat: no-repeat;"><!-- ======= Team Section ======= -->
<?php
    ...
    <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <center><h2 class="text-white">Team</h2></center>
          <center><h1 class="text-white">Meet The Crew </h1></center>
          <p class="text-white">"No one can whistle a symphony. It takes a whole orchestra to play it"
