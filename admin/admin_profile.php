					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-6" style="margin-top: 20px;">
								<h4 class="text-white"><?php echo $username; ?> Profile</h4>
								...
								<?php
									...
									if(isset($_POST['update']))
									{
										...
										{
											$sql = "UPDATE clg_admin set profile='$profile' where username='$ad'";
							...
							<div class="col-md-6">
								...
								<?php
									...
									if(isset($_POST['change']))
									{
										...
										{
											$sql = "UPDATE clg_admin set username='$uname' where username='$ad'";

											$res = mysqli_query($connect,$sql);

											if($res)
											{
												$_SESSION['clg_admin'] = $uname;
											}
										}
									}
								?>
								...
								<?php
									...
									if(isset($_POST['update_pass']))
									{
										...
										$old = mysqli_query($connect,"SELECT * from clg_admin where username='$ad'");
										...
										if(count($error) == 0)
										{
											$sql = "UPDATE clg_admin set password='$new_pass' where username='$ad'";
